...
def create_invoice(request: Request, invoice_data: InvoiceCreate, db:Session = Depends(get_db), current_user= Depends(get_current_user)):
...
@limiter.limit("5/minute")
def get_invoice_by_subscription(request: Request, subscription_id : int, db:Session = Depends(get_db), current_user= Depends(get_current_user)):
...
@limiter.limit("5/minute")
def pdf_creation(request: Request, invoice_id: int , customer_id: int , db: Session = Depends(get_db),current_user = Depends(get_current_user)):
...
@limiter.limit("5/minute")
def send_invoice(request: Request, invoice_id: int, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
@limiter.limit("5/minute")
def get_invoice_by_id(request: Request, invoice_id : int, db:Session = Depends(get_db), current_user= Depends(get_current_user)):
...
@limiter.limit("5/minute")
def get_all_invoices(request: Request, customer_id : int, db:Session = Depends(get_db), current_user= Depends(get_current_user)):
...
@limiter.limit("5/minute")
def update_invoice(request: Request, invoice_id : int, invoice_update : InvoiceUpdate, db:Session = Depends(get_db), current_user= Depends(get_current_user)):
